...
extern GoInt WriteGroupMessage(char* group, char* msg);
extern void ChatJoinGroup(char* group);
extern void ChatAllowJoin(char* group, char* username);
extern void ChatCreateGroup(char* group);
extern TmpFiles* ChatCloudFiles();
